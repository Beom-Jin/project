...
<main class="container">
  ...
  <section class="grid cols-4" aria-label="추천 장소 목록">
    ...
    <article class="card">
      ...
      <div class="meta">
        <div class="place">힐링 여행1</div>
        <span class="tag">힐링 여행1</span>
      </div>
    </article>
    <!-- 2 -->
    <article class="card">
      <div class="thumb" aria-hidden="true"></div>
      <div class="meta">
        <div class="place">힐링 여행2</div>
        <span class="tag">힐링 여행2</span>
      </div>
    </article>
    <!-- 3 -->
    <article class="card">
      <div class="thumb" aria-hidden="true"></div>
      <div class="meta">
        <div class="place">힐링 여행3</div>
        <span class="tag">힐링 여행3</span>
      </div>
    </article>
    <!-- 4 -->
    <article class="card">
      <div class="thumb" aria-hidden="true"></div>
      <div class="meta">
        <div class="place">힐링 여행4</div>
        <span class="tag">힐링 여행4</span>
      </div>
    </article>
    <!-- 5 -->
    <article class="card">
      <div class="thumb" aria-hidden="true"></div>
      <div class="meta">
        <div class="place">힐링 여행5</div>
        <span class="tag">힐링 여행5</span>
      </div>
    </article>
    <!-- 6 -->
    <article class="card">
      <div class="thumb" aria-hidden="true"></div>
      <div class="meta">
        <div class="place">힐링 여행6</div>
        <span class="tag">힐링 여행6</span>
      </div>
    </article>
    <!-- 7 -->
    <article class="card">
      <div class="thumb" aria-hidden="true"></div>
      <div class="meta">
        <div class="place">힐링 여행7</div>
        <span class="tag">힐링 여행7</span>
      </div>
    </article>
    <!-- 8 -->
    <article class="card">

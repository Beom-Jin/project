        ...
        <style>
            ...
            * {
            ...
            .input:focus {
                background: #fff;
                border-color: var(--focus);
                box-shadow: 0 0 0 4px rgba(76, 154, 255, 0.15);
            }
            .icon {
                position: absolute;
                left: 14px;
            ...
            .btn {
                ...
                font-size: 18px;
                cursor: pointer;
                transition: background 0.15s, transform 0.02s ease-in-out;
            }
            .btn:hover {
            ...
            <section class="card" aria-labelledby="title">
                ...
                <form action="/checkIdExists" method="post" autocomplete="off">
                    <label class="field" aria-label="아이디 입력">
                        ...
                        <input class="input" type="text" name="m_id" id="m_id" placeholder="아이디 또는 단체 아이디" autocomplete="off" required />
                    </label>
                    ...
                    <p class="help">아이디가 기억나지 않는다면? <a href="/getid">아이디 찾기</a></p>
                </form>
